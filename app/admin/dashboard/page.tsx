...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const cargarTodo = async () => {
      try {
        // Ejecutamos en paralelo solo lo necesario
        const [dataStats, dataRanking] = await Promise.all([
          obtenerEstadisticasBecas(),
          obtenerRankingPrioridad() // Ya optimizado con filtros opcionales
        ])
        ...
        setLoading(false) // Quitamos el spinner termine bien o mal
      }
    }
    cargarTodo()
  }, [])
  ...
  // Sumamos 'Pendiente' y 'En Revisión' para la alerta
  ...
  return (
    <div className="w-full min-h-screen bg-[#f8fafc]">
      ...
      <div className="sticky top-0 z-30 bg-[#f8fafc] h-16 flex items-center px-6 md:px-8 shadow-sm md:shadow-none">
      ...
      <div className="p-6 md:p-8 space-y-8 pb-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
           ...
           <div className="h-96 animate-in fade-in zoom-in-95 duration-500 delay-200">
        ...
        {/* IA PREDICTORA */}
        <div className="bg-gradient-to-r from-[#1e3a5f] to-[#1a2744] p-8 rounded-3xl shadow-xl text-center text-white relative overflow-hidden border-b-8 border-[#d4a843] animate-in slide-in-from-bottom-8 duration-700">
