...
export default function ActividadPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f8fafc] flex flex-col">
      ...
      {/* --- HEADER --- */}
      <div className="sticky top-0 z-30 bg-[#f8fafc] h-16 flex items-center px-6 md:px-8 border-b border-transparent shrink-0">
        <div className="w-full bg-white px-6 py-2 rounded-xl shadow-sm border border-slate-200 flex justify-between items-center">
          ...
          <div className="flex items-center gap-5 border-l border-slate-100 pl-5">
            <Link href="/admin/dashboard" title="Volver al Dashboard">
                <div className="text-[10px] font-bold text-slate-500 hover:text-[#1a2744] uppercase tracking-wider cursor-pointer">
                    Volver
                </div>
            </Link>
      ...
      <div className="p-6 md:p-8 flex-1 overflow-hidden flex flex-col">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 flex flex-col h-full max-h-[80vh]">
          <div className="bg-slate-50 px-6 py-5 border-b flex justify-between items-center shrink-0">
            <h3 className="text-xs font-black text-[#1a2744] uppercase tracking-widest flex items-center gap-2">
              <Clock className="h-4 w-4 text-[#d4a843]" /> Últimos 50 Movimientos del Sistema
            </h3>
        ...
        <p className="text-center text-[8px] text-gray-400 font-bold uppercase tracking-[0.5em] py-4 shrink-0">
