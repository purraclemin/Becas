...
export function HealthStatus({ porEstatus, total }: { porEstatus: any[], total: number }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 flex flex-col h-full">
      <h3 className="font-black text-[#1a2744] text-[9px] uppercase tracking-widest flex items-center gap-2 mb-4">
      ...
      <div className="space-y-4 flex-1 flex flex-col justify-center">
        {porEstatus?.map((item, idx) => {
          ...
          return (
            ...
            >
              {/* Encabezado reducido */}
              <div className="flex justify-between text-[8px] font-black uppercase tracking-widest text-slate-500 group-hover:text-[#1a2744] transition-colors">
                ...
                <span className="text-[#1a2744] bg-slate-50 px-1.5 py-0.5 rounded group-hover:bg-[#1a2744] group-hover:text-white transition-colors">
