...
/**
 * 🟢 COMPONENTE: CONTENEDOR DE SECCIÓN PRINCIPAL (Acordeón de alto nivel)
 * Se eliminaron animaciones de desplazamiento para no interferir con el scroll automático.
 */
...
      </button>
      
      <div className={`px-5 pb-6 pt-2 ${estaAbierto ? "block fade-in duration-200" : "hidden"}`}>
        {children}
      </div>
    </div>
  )
...
/**
 * 🟢 COMPONENTE: SECCIÓN INTERNA (Sub-acordeón dentro de la encuesta)
 * Optimizado para clics rápidos: el contenido aparece sin animaciones de empuje.
 */
...
      </button>
      
      <div className={`pb-6 pt-2 space-y-6 ${isOpen ? "block fade-in duration-200" : "hidden"}`}>
        {children}
      </div>
    </div>
  )
